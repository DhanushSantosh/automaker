...
exports.DEFAULT_TERMINAL_FONT = exports.TERMINAL_FONT_OPTIONS = void 0;
exports.getTerminalFontFamily = getTerminalFontFamily;
exports.getTerminalTheme = getTerminalTheme;
const ui_font_options_1 = require('@/config/ui-font-options');
/**
 ...
 */
exports.TERMINAL_FONT_OPTIONS = ui_font_options_1.UI_MONO_FONT_OPTIONS.map((option) => {
  // Replace the UI default label with terminal-specific default
  if (option.value === ui_font_options_1.DEFAULT_FONT_VALUE) {
 ...
 */
exports.DEFAULT_TERMINAL_FONT = ui_font_options_1.DEFAULT_FONT_VALUE;
/**
 * Get the actual font family CSS value for terminal
 * Converts DEFAULT_FONT_VALUE to the actual Menlo/Monaco font stack
 */
function getTerminalFontFamily(fontValue) {
  if (!fontValue || fontValue === ui_font_options_1.DEFAULT_FONT_VALUE) {
...
exports.default = terminalThemes;
